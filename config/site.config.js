...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'felchen@o365.scut.edu.cn',
  ...
  protectedRoutes: ['/Private folder/u-need-a-password', '/Private folder/AFG'],
