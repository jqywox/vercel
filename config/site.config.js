...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'y@ancpy.onmicrosoft.com',
  ...
  protectedRoutes: ['/🌞 Private folder/u-need-a-password', '/🥟 Private folder/Protected route'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:spencer.ak43o@gmail.com',
